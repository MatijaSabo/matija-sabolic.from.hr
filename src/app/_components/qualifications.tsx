...
export default function Qualifications({ education, certificates }: Props) {
    return (
        <Section>
            <h2 className="text-2xl xl:text-4xl font-bold tracking-tighter md:pr-8 pb-6 xl:pb-8">Qualifications & Certificates</h2>

            <div className="text-base xl:text-xl tracking-tighter md:pr-8 pb-6 xl:pb-8">
                <p>
                    ...
                    {education.diploma}, {education.university}
                </p>
            </div>
            ...
            {certificates.map((item, key) => {
                return <div className="text-base xl:text-xl tracking-tighter md:pr-8">
                    ...
                    <ol className="my-2 xl:my-4 ml-6 list-disc">
                        {item.certificateList.map((element) => {
